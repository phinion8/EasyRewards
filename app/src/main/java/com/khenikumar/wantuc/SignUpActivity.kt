...
import com.khenikumar.wantuc.databinding.ActivitySignUpBinding
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.termsBtn.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://pages.flycricket.io/want-uc-0/terms.html"))
