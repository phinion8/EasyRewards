...
import com.khenikumar.wantuc.databinding.FragmentHomeBinding
import com.khenikumar.wantuc.databinding.LoadingDialogLayoutBinding
import com.khenikumar.wantuc.databinding.SuccessDialogLayoutBinding
import com.khenikumar.wantuc.databinding.WarningDialogBinding
import com.khenikumar.wantuc.models.User
import com.khenikumar.wantuc.utils.Constants
    ...
    override fun onCreateView(
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                if (value != null) {
                    dailyRewardAmount = value.get("rewardAmount").toString().toInt()
                    binding.dailyRewardCoinText.text = dailyRewardAmount.toString()
                    val dailyRewardDes: String = this.getString(com.khenikumar.wantuc.R.string.earn) + " " + dailyRewardAmount.toString() + " " + this.getString(com.khenikumar.wantuc.R.string.daily_reward_description)
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                ...
                val dailyRewardDes: String = this.getString(com.khenikumar.wantuc.R.string.earn) + " " + scratchRewardAmount.toString() + " " + this.getString(com.khenikumar.wantuc.R.string.scratch_card_description)
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                val spinRewardAmount = value?.get("randomReward8").toString().toInt()
                binding.spinCoin.text = spinRewardAmount.toString()
                val spinRewardDes: String = this.getString(com.khenikumar.wantuc.R.string.earn) + " " + spinRewardAmount.toString() + " " + this.getString(com.khenikumar.wantuc.R.string.spin_wheel_description)
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                ...
                val luckyNumberDes: String = this.getString(com.khenikumar.wantuc.R.string.earn) + " " + luckyRewardAmount.toString() + " " + this.getString(com.khenikumar.wantuc.R.string.lucky_number_description)
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                val rewardAmount = value?.get("referReward").toString().toInt()
                binding.referCoin.text = rewardAmount.toString()
                val referDes: String = this.getString(com.khenikumar.wantuc.R.string.earn) + " " + rewardAmount.toString() + " " + this.getString(com.khenikumar.wantuc.R.string.refer_description)
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener{value, error->
                ...
                successDialogLayoutBinding.successText.text = dailyReward + " " + this.getString(com.khenikumar.wantuc.R.string.final_spin_reward_text)
            }
