...
import com.khenikumar.wantuc.adapters.WithdrawalMethodAdapter
import com.khenikumar.wantuc.databinding.FragmentWalletBinding
...
import com.khenikumar.wantuc.models.WithdrawalRequest
import com.khenikumar.wantuc.utils.CheckForInternet
        ...
        database.collection("earningSystems")
            ...
            .addSnapshotListener { value, error ->
                ...
                binding.withdrawalEmail.hint =
                    this.getString(com.khenikumar.wantuc.R.string.enter_your) + " " + withdrawalMethodText + " " + this.getString(
                        com.khenikumar.wantuc.R.string.email_address
                    )
                binding.minimumDes.text =
                    this.getString(com.khenikumar.wantuc.R.string.minimum_des) + " " + minimumCoin.toString()

                binding.withdrawalValueText.text =
                    this.getString(com.khenikumar.wantuc.R.string.note) + " " +
                            "" + withdrawalCoinValue + " " + this.getString(com.khenikumar.wantuc.R.string.withdrawal_value_1) + " " + withdrawalValue
